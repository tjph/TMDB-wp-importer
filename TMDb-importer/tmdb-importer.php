...
//API_KEY = "42f5488334aac658ab6b5c046eb6c717";
//https://api.themoviedb.org/3/discover/movie?api_key=42f5488334aac658ab6b5c046eb6c717&primary_release_year=2014&page=1&
...
function tmdb_imp(){
  ...
  if ( $import_type == 1 && $istartdate !='' && $ienddate !='' && $iyear !='' || $import_type == 3 && $istartdate !='' && $ienddate !='' && $iyear !='' ) {
        ...
        $tmdb_calla = "https://api.themoviedb.org/3/discover/movie?api_key=42f5488334aac658ab6b5c046eb6c717&primary_release_year=".$vma_year."&primary_release_date.gte=".$startdate."&primary_release_date.lte=".$enddate."&page=1&sort_by=release_date.asc&vote_count.gte=".$_GET[ 'popularity' ]; //certification_country=US&certification.lte=NC-17
      ...
      while ($i <= $nb_pages) {
        ...
        //set_time_limit( 20 );
        $i++;
        $tmdb_call = "https://api.themoviedb.org/3/discover/movie?api_key=42f5488334aac658ab6b5c046eb6c717&primary_release_year=".$vma_year."&primary_release_date.gte=".$startdate."&primary_release_date.lte=".$enddate."&page=".$i."&sort_by=release_date.asc&vote_count.gte=".$_GET[ 'popularity' ]; //&certification_country=US&certification.lte=NC-17
        ...
        foreach ($movies->results as $movie) {
            ...
            $tmdb_movie_call = "https://api.themoviedb.org/3/movie/".$movie->id."?api_key=42f5488334aac658ab6b5c046eb6c717&append_to_response=credits,trailers,releases";
...
function tmdb_imp_uniq(){
  ...
  if ( $_GET[ 'tmdb_import' ] == 2 && $_GET[ 'movie_id' ] && current_user_can( 'manage_options' ) ) {
    ...
    error_log("Start Single Movie Import '$m' as parameters.");
      ...
      $tmdb_movie_call = "https://api.themoviedb.org/3/movie/".$m."?api_key=42f5488334aac658ab6b5c046eb6c717&append_to_response=credits,trailers,releases";
      $movie_data = tmdb_curl($tmdb_movie_call);
